...
const predefinedProblems = {
  ...
  "What are some tips for maintaining a healthy diet with a chronic illness?": {
    short: "Consult a dietitian, focus on nutrition, meal planning.",
    long: "Work with a registered dietitian to create a personalized meal plan that aligns with your specific dietary needs and restrictions. Prioritize nutrient-rich foods like fruits, vegetables, whole grains, lean proteins, and healthy fats. Incorporate a variety of colors into your meals to ensure a wide range of vitamins and minerals. Stay hydrated by drinking plenty of water throughout the day. Listen to your body's hunger cues and avoid skipping meals. Consider meal prepping to save time and ensure you have healthy options readily available. Make gradual changes to your diet to avoid feeling overwhelmed. Seek support from friends, family, or support groups to help you stay motivated and accountable. Remember, consistency is key, so focus on sustainable lifestyle changes rather than quick fixes."
  }
};
